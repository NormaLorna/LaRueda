...
<meta property="twitter:image" content="https://www.laruedanoticias.com.ar/fotos/<?php echo $fila["noti_foto"]; ?>" />
  ...
  <div class="cuerpo">
    ...
    <?php include "encabezado.php" ?>
      ...
      <div class="noticiampliada"> 
        ...
        <?php if ($fila["noti_video"]!="") 
        { ?> 

          <iframe  class="videoP" width="600" height="450"src="<?php  echo $fila["noti_video"]; ?>" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
